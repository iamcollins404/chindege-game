...
export const ConfirmationModal = ({ isOpen, onClose, onConfirm, betAmount, playClick }) => {
  useEffect(() => {
    if (isOpen) {
          ...
          >
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-8 rounded-2xl shadow-2xl border border-gray-700">
              <div className="text-center">
                <h2 className="text-2xl font-bold mb-4 text-white">Confirm Play</h2>
                <p className="text-gray-300 mb-6">
                  Are you sure you want to bet <span className="font-bold text-green-400">${betAmount}</span>?
                </p>
